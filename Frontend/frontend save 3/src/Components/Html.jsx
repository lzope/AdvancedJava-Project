...
import Htmlv from '../Video/Htmlv.mp4';
      ...
      <div id="boom" className="col-md-12 mt-5 container fluid">
        <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
          <div className="col p-4 d-flex flex-column position-static">
            ...
            <h3 className="mb-0">The Complete HTML From Zero to Hero in HTML</h3>
            <br />
            <div className="mb-1 text-body-secondary">Duration: 2 Months</div>
            <br />
            <h5 className="card-text mb-auto">
              Learn HTML like a Professional. Start from the basics and go all the way to creating your own applications
            </h5>
          </div>
          <div className="col-auto">
            <video width="300" height="350" controls>
              <source src={Htmlv} type="video/mp4" />
